$(document).ready(function() {
	...
	$("#timeDiv").load("http://csis.svsu.edu/~gpcorser/cis255/gpcorser/currentTime.php");
	//$("#timeDiv").load("http://api.svsu.edu/courses?prefix=CIS&courseNumber=255");

	// example GET request
	var jqxhr = $.get("http://csis.svsu.edu/~gpcorser/cis255/gpcorser/currentTime.php", function (data,textStatus,jsxhr) {
	...
	var jqxhr = $.ajax(
		{
			url   : "http://csis.svsu.edu/~gpcorser/cis255/gpcorser/currentTime.php",
			data  : "zippy",
			async : true, 
			type  : "POST"
		}

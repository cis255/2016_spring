//Zaiter's JavaScript I renamed some functions to my liking.
...
function degreeToggle(degreeName)
{
...
function submit()
{
	...
	var coursesNotEligibleElement = document.getElementById("coursesNotEligible");

...
var words = new String("Hello");
console.log(words.countChars("l"));

//The following 3 lines both output Topic 1
...
console.log(chk.attr("checked", false));
console.log(chk.prop("checked"));
console.log(chk.attr("checked"));
